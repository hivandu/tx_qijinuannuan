...
var concatOrder = {
    ...
    js: [
        ...
        filePath.js + 'iSlider.min.js',
        filePath.js + 'iSlider.animate.min.js',
        filePath.js + 'main.js'
    ]
};
...
gulp.task('watch', function() {
    ...
    gulp.watch(['assets/**']).on('change', function(){ browserSync.reload });
    gulp.watch(['assets/script/*.js']).on('change', browserSync.reload );
...
gulp.task('deploy', function () {
    runSequence('cleanDist', 'sass', 'concatCss', 'scripts', 'copyHtml', 'copyCss','copyFont', 'copyScripts', 'copyImages', 'injector');
});
...
gulp.task('copyFont', function() {
    return gulp.src(filePath.font + '/**/*')
        .pipe(gulp.dest(filePath.fontDist))
        .pipe(notify({ message: 'Dist font task complete' }));
});
